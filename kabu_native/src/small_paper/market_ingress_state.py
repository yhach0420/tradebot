...
ALLOWED_TRANSITIONS: dict[str, frozenset[str]] = {
    ...
    AUTH_FAILED: frozenset({STOPPING, STOPPED, RECONNECTING}),
    REGISTER_FAILED: frozenset({STOPPING, STOPPED, REREGISTERING}),
    CURRENT_STAGE_TOKEN_NOT_READY: frozenset({STOPPING, STOPPED, REGISTERING}),
