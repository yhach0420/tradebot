"""
Phase361: Near day high + low momentum ENTRY guard shadow validation (post-Phase355).
"""
...
from small_paper.near_day_high_low_mom_entry_guard_shadow import SPLIT_VARIANTS, variant_blocked
...
TRADE_FIELDS = [
    ...
    "near_day_high_low_mom_guard_shadow_blocked",
    "near_day_high_low_mom_shadow_pnl_yen_100",
    "near_day_high_low_mom_shadow_delta_yen",
...
@dataclass
class Phase361NearDayHighLowMomValidation:
    reports_dir: Path
    session_results: list[dict[str, Any]] = field(default_factory=list)

    def paths(self) -> dict[str, Path]:
        return {
            "summary": self.reports_dir / "phase361_near_day_high_low_mom_guard_summary.json",
            "by_variant": self.reports_dir / "phase361_near_day_high_low_mom_guard_by_variant.csv",
            "by_day": self.reports_dir / "phase361_near_day_high_low_mom_guard_by_day.csv",
            "by_symbol": self.reports_dir / "phase361_near_day_high_low_mom_guard_by_symbol.csv",
            "trades": self.reports_dir / "phase361_near_day_high_low_mom_guard_trades.csv",
        }
    ...
    def finalize_outputs(self, *, wall_runtime_sec: float, sessions_discovered: int) -> dict[str, Path]:
        ...
        summary = {
            "phase": 361,
            "title": "near_day_high_low_mom_guard_validation",
            "guard": "C03_near_day_high_low_mom_guard",
            ...
            "phase355_combo": {
                ...
                "C03 guard is additive to Phase355.",
