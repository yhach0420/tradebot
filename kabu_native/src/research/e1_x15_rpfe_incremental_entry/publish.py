"""Publish E1_X15 three artifacts."""
...
SHEETS = [
    "Index", "SourceIdentity", "ThresholdContract", "RPFEEpisodes", "CandidateDefinitions",
    "AnchorSelection", "MatchedComparison", "DirectionalOutcomes", "FirstTouch", "NoProgress",
    "IncrementalValue", "DailyBalance", "SymbolBalance", "LODO", "LOSO", "Exclude20260722",
    "FreshnessStrata", "CandidateSelection", "ProspectivePrecommit", "Tests", "Determinism",
    "Safety", "ChangeLog",
]
...
def publish(report: dict[str, Any], tests: dict[str, Any], det: dict[str, Any], out_dir: Path) -> dict[str, str]:
    ...
    md = [
        ...
        f"- study_type: `{report.get('study_type')}` (not historical holdout / not robust)",
