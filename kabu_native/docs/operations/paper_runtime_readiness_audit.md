...
**Verdict:** `paper_runtime_readiness_failed`
**Ready:** `False`
...
**run_paper_trade.bat safe for standalone Tuesday paper trade:** `False`
...
- 7_entry_exit_summary_parity: FAIL — "_execute_accepted_entry() missing 1 required keyword-only argument: 'score5_ord'"
