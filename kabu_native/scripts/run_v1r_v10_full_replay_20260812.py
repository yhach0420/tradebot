#!/usr/bin/env python
"""2026-08-12 Full Capture Replay after native full-PUSH ingest fix (V10).

V9/V8/V7/V6/V5/V4 manifests are immutable history. Strategy/Precommit unchanged.
"""
...
V8_ID = "V1R_EXIT_V2_PAPER_PRIMARY_ACTIVATION_V8"
V8_SHA = "1d3e7c3d9644b7db60f4cc2524ba2ce4065f78fe4cff3cec86971ff97e25954f"
V9_ID = "V1R_EXIT_V2_PAPER_PRIMARY_ACTIVATION_V9"
...
OUT = ROOT / "results" / "research" / "v1r_v10_full_replay_20260812"
...
def v9_immutable_precheck() -> dict:
    ...
    v8 = json.loads((ACT_DIR / f"{V8_ID}.json").read_text(encoding="utf-8"))
    v9 = json.loads((ACT_DIR / f"{V9_ID}.json").read_text(encoding="utf-8"))
    ...
    ok8, _, calc8 = verify_manifest_self_sha(v8)
    ok9, _, calc9 = verify_manifest_self_sha(v9)
    checks = {
        ...
        "v8_self_sha": ok8 and v8.get("sha256") == V8_SHA == calc8 == manifest_content_sha(v8),
        "v9_self_sha": ok9 and v9.get("sha256") == V9_SHA == calc9 == manifest_content_sha(v9),
        "strategy": v9.get("strategy_sha") == STRATEGY_SHA == v8.get("strategy_sha") == v4.get("strategy_sha"),
        "precommit": v9.get("precommit_sha") == PRECOMMIT_SHA == v8.get("precommit_sha"),
    ...
    return {
        ...
        "v8_content_sha": v8.get("sha256"),
        "v9_content_sha": v9.get("sha256"),
        "note": "V9/V8/V7/V6/V5/V4 immutable; V10 freeze is separate",
    }
...
def main() -> int:
    ...
    v4h.OUT = OUT
    v4h.v3_immutable_precheck = v9_immutable_precheck  # type: ignore[method-assign]
    ...
    if report_path.is_file():
        ...
        if rep.get("verdict") == "V1R_V4_20260812_FULL_REPLAY_E2E_PASS":
            rep["verdict"] = "V1R_V10_20260812_FULL_REPLAY_E2E_PASS"
        elif rep.get("verdict") == "V1R_V4_20260812_FULL_REPLAY_E2E_FAIL":
            rep["verdict"] = "V1R_V10_20260812_FULL_REPLAY_E2E_FAIL"
        ...
        print("V10_REPLAY_VERDICT", rep.get("verdict"), "blockers", rep.get("blockers"), flush=True)
