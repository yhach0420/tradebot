#!/usr/bin/env python3
"""Phase451B entry shape tournament (Board mid+high) runner."""
...
def main() -> int:
    _bootstrap()
    from research.phase451b_entry_shape_tournament_mid_high import Phase451BJob

    job = Phase451BJob(repo_root=REPO)
    result = job.run()
