#!/usr/bin/env python3
"""Phase542 — Guard v2 threshold tuning runner."""
...
def main() -> int:
    _bootstrap()
    parser = argparse.ArgumentParser(description="Phase542 Guard v2 threshold tuning")
    ...
    from research.phase542_guard_v2_threshold_tuning import Phase542Job
