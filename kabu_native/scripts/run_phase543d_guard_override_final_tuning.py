#!/usr/bin/env python3
"""Phase543D — Guard override final tuning runner."""
...
def main() -> int:
    _bootstrap()
    parser = argparse.ArgumentParser(description="Phase543D override final tuning")
    ...
    from research.phase543d_guard_override_final_tuning import Phase543DJob
