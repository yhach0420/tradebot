...
def main() -> int:
    parser = argparse.ArgumentParser(description="Phase404 no progress exit shadow")
    ...
    _bootstrap()
    from research.phase404_no_progress_exit_shadow import run_phase404_shadow

    result = run_phase404_shadow(
    ...
    print(json.dumps(summary.get("mandatory_analysis") or {}, indent=2, ensure_ascii=False))
