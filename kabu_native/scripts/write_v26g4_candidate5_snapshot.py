#!/usr/bin/env python
"""Write UNCERTIFIED immutable V26-G4 Candidate-5 snapshot.

Run ONLY after targeted RCA proofs PASS (user §15).
Does not mutate V25 / Candidate-1 / V26G3_2 / V26G3_3 / V26G3_4.
Does not Formal-freeze V26. Does not overwrite G4 working-tree snapshot identity.
"""
...
CANDIDATE_ID = "V1R_EXIT_V2_PAPER_PRIMARY_CANDIDATE_V26G4_5"
SELECTOR_CANDIDATE = OUT / "active_v1r_candidate_v26g4_5.json"
...
def main() -> int:
    ...
    if dest.is_file() or SELECTOR_CANDIDATE.is_file():
        print("REFUSE_OVERWRITE: candidate-5 snapshot already exists", dest, SELECTOR_CANDIDATE)
        return 2
    ...
    body.update(
        {
            ...
            "supersede_reason": "V26G4_UNCERTIFIED_RUNTIME_FIX_CANDIDATE5",
            ...
            "parent_failed_candidate_id": "V1R_EXIT_V2_PAPER_PRIMARY_CANDIDATE_V26G3_4",
            "parent_failed_candidate_sha": "fa8811c5df4c4a0647a8a5311c5b1197b2c7a0a6a5d35f396383388f5ec88686",
    ...
    selector = {
        ...
        "note": "Identity-only UNCERTIFIED candidate-5 selector; not the active Formal selector.",
    }
