#!/usr/bin/env python3
"""Phase458 VWAP structure similarity audit runner."""
...
def main() -> int:
    _bootstrap()
    from research.phase458_vwap_structure_similarity_audit import Phase458Job

    job = Phase458Job(repo_root=REPO)
    result = job.run()
