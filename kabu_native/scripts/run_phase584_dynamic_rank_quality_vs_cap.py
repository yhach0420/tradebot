#!/usr/bin/env python3
"""Phase584 — Dynamic rank quality vs CAP competition analysis."""
...
def main() -> int:
    ...
    from research.phase584_dynamic_rank_quality_vs_cap import Phase584Job

    job = Phase584Job(repo_root=REPO, workers=workers)
    result = job.run()
