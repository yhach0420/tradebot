#!/usr/bin/env python
"""Write a working-tree UNCERTIFIED snapshot for V26-G6 targeted RCA runs.

Not Candidate-6. Not Candidate-5. Not Formal. Overwrite allowed as source changes.
"""
...
def main() -> int:
    ...
    dest = G6_DIR / f"{WORKING_ID}.json"
    selector_path = G6_DIR / "active_v1r_working_v26g6.json"
    ...
    body.update(
        {
            ...
            "supersede_reason": "V26G6_TARGETED_WORKING_TREE_NOT_CANDIDATE_6",
    ...
    selector = {
        ...
        "note": "Working-tree selector for V26-G6 targeted RCA only. Not Candidate-5/6. Not Formal.",
    }
