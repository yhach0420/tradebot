#!/usr/bin/env python3
"""Phase544 — ENTRY feature attribution runner."""
...
def main() -> int:
    _bootstrap()
    parser = argparse.ArgumentParser(description="Phase544 entry feature attribution")
    ...
    from research.phase544_entry_feature_attribution import Phase544Job
