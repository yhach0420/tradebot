#!/usr/bin/env python
"""2026-08-12 Full Capture Replay after registered Kabu probe single-authority fix.

V8/V7/V6/V5/V4 manifests are immutable history. Strategy/Precommit unchanged.
"""
...
OUT = ROOT / "results" / "research" / "v1r_v9_full_replay_20260812"
...
def v8_immutable_precheck() -> dict:
    ...
    checks = {
        ...
        "strategy": v8.get("strategy_sha") == STRATEGY_SHA == v7.get("strategy_sha") == v4.get("strategy_sha"),
        "precommit": v8.get("precommit_sha") == PRECOMMIT_SHA == v7.get("precommit_sha"),
    ...
    return {
        ...
        "note": "V8/V7/V6/V5/V4 immutable; V9 freeze is separate",
    }
...
def main() -> int:
    ...
    v4h.OUT = OUT
    v4h.v3_immutable_precheck = v8_immutable_precheck  # type: ignore[method-assign]
    ...
    if report_path.is_file():
        ...
        if rep.get("verdict") == "V1R_V4_20260812_FULL_REPLAY_E2E_PASS":
            rep["verdict"] = "V1R_V9_20260812_FULL_REPLAY_E2E_PASS"
        elif rep.get("verdict") == "V1R_V4_20260812_FULL_REPLAY_E2E_FAIL":
            rep["verdict"] = "V1R_V9_20260812_FULL_REPLAY_E2E_FAIL"
        ...
        print("V9_REPLAY_VERDICT", rep.get("verdict"), "blockers", rep.get("blockers"), flush=True)
