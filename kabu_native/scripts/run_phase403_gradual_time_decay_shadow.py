...
def main() -> int:
    parser = argparse.ArgumentParser(description="Phase403 gradual time-decay MFE shadow")
    ...
    _bootstrap()
    from research.phase403_gradual_time_decay_shadow import run_phase403_shadow

    result = run_phase403_shadow(
