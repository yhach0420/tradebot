"""Paper trade stop/take, entry-quality, deferral, trace — imported from ``yahoo_kabu_paper_trade_impl``."""
...
def _paper_trade_dynamic_low_rr_shadow_tables(replay_signals: list[Any]) -> list[dict[str, Any]]:
    from yahoo_kabu_paper_trade_impl import _baseline_pnl, _shadow_exit_removed_counts
...
def run_paper_trade_dry_run_replay(*, dry_run_day: str, replay_config_path: str, script_dir: str) -> int:
    """Dry-run replay: delegates to yahoo_kabu_watch.run_paper_trade_dry_run_replay_impl (real replay loop)."""
    import yahoo_kabu_watch as _yk
